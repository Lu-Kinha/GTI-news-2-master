          ...
          <header class="mb-4 lg:mb-6 not-format">
              <address class="flex items-center mb-6 not-italic">
                  <div class="inline-flex items-center mr-3 text-sm text-gray-900 dark:text-white">
                      <img class="mr-4 w-16 h-16 rounded-full" src="https://i.pinimg.com/736x/54/84/8e/54848eafb83e92ea29325e29d7f6af22.jpg" alt="Lucas">
                      <div>
                          <a href="#" rel="author" class="text-xl font-bold text-gray-900 dark:text-white">Lucas Melo</a>
                          <p class="text-base text-gray-500 dark:text-gray-400">Gerente de T.I e Jornalista Esportivo</p>
